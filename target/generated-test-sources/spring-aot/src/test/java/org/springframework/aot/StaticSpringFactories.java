...
public abstract class StaticSpringFactories {
  ...
  static {
    ...
    names.add(EnableAutoConfiguration.class, "org.springframework.boot.autoconfigure.data.rest.RepositoryRestMvcAutoConfiguration");
    names.add(EnableAutoConfiguration.class, "org.springframework.boot.autoconfigure.data.web.SpringDataWebAutoConfiguration");
    names.add(EnableAutoConfiguration.class, "org.springframework.boot.autoconfigure.hateoas.HypermediaAutoConfiguration");
    ...
    names.add(EnableAutoConfiguration.class, "org.springframework.boot.autoconfigure.session.SessionAutoConfiguration");
    ...
    names.add(EnableAutoConfiguration.class, "org.springframework.boot.autoconfigure.webservices.WebServicesAutoConfiguration");
    names.add(EnableAutoConfiguration.class, "org.springframework.boot.autoconfigure.webservices.client.WebServiceTemplateAutoConfiguration");
    ...
    names.add(AutoConfigureWebFlux.class, "org.springframework.boot.autoconfigure.web.reactive.WebFluxAutoConfiguration");
