...
* The following dependencies are not known to work with Spring Native: 'Rest Repositories, Spring Session, Spring Web Services'. As a result, your application may not work as expected.
